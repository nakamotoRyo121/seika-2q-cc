...
const gsapEffects = [
  ...
  gsapEffects.forEach(effect => {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerEffect({
      name: effect.id,
      defaults: { duration: 1 },
      extendTimeline: true,
      effect(targets, config) {
        if(effect.animate === 'from'){
          return gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(targets, {...effect.props,...config })
        } 
        else if (effect.animate === 'fromTo'){ 
          return gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(targets, {...effect.props,...config }, {...effect.props2})
          }
        else {
          return gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(targets, {...effect.props,...config })
        }
      }
    });
  });
